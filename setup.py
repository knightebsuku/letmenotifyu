...
if __name__=='__main__':
    setup(name='letmenotifyu',
          ...
          packages=['notifylib'],
          data_files=[('share/applications',['ui/letmenotifyu.desktop']),('share/letmenotifyu',['ui/about7.glade','ui/confirm7.glade','ui/input7.glade', 'ui/main7.glade']), ('share/letmenotifyu',['ui/letmenotifyu.png','ui/letmenotifyu.xpm'])]
