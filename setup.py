    ...
    setup(name='letmenotifyu',
          ...
          data_files=[('share/applications',
                      ...
                      ('share/letmenotifyu/icons',
                       ['icons/Action.png', 'icons/Cartoon.png', 'icons/Documentary.png',
                        'icons/Foreign.png', 'icons/Mystery.png',
                        'icons/War.png', 'icons/Adventure.png', 'icons/Comedy.png',
                        'icons/Drama.png', 'icons/Historic.png',
                        'icons/Romance.png', 'icons/Western.png', 'icons/Animation.png',
                        'icons/Comic.png', 'icons/Family.png',
                        'icons/Horror.png', 'icons/Sci-Fi.png', 'icons/Biography.png',
                        'icons/Crime.png', 'icons/Fantasy.png',
                        'icons/Musical.png', 'icons/Thriller.png', 'icons/Film-Noir.png']),
                        ])
